Warning: truncated output (original token count: 80020)
...
function LiveGame({ onHome }) {
  ...
  async function sendOwn() {
    try {
      const resp = await fetch("/api/game", { method: "POST", headers: { "Content-Type": "application…20020 tokens truncated…🟢 CANON — solo esto es verdad</div>
